...
import PickLists from "../../../components/picklists/PickLists";
...
const PicklistsIndex = ({ userslist, token, apiBaseUrl }) => {
...
PicklistsIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistsIndex);
