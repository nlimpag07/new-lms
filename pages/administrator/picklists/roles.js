...
import Roles from "../../../components/picklists/roles/Roles";
...
const PicklistRolesIndex = ({ data, token, apiBaseUrl }) => {
...
PicklistRolesIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistRolesIndex);
