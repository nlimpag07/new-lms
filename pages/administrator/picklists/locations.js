...
import Locations from "../../../components/picklists/locations/Locations";
...
const PicklistLocationsIndex = ({ data, token, apiBaseUrl }) => {
...
PicklistLocationsIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistLocationsIndex);
