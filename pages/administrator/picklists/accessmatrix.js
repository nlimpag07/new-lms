...
import AccessMatrix from "../../../components/picklists/accessmatrix/AccessMatrix";
...
const PicklistAccessMatrixIndex = ({ data, token, apiBaseUrl }) => {
...
PicklistAccessMatrixIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistAccessMatrixIndex);
