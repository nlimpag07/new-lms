...
import Languages from "../../../components/picklists/languages/Languages";
...
const PicklistLanguageIndex = ({ data, token, apiBaseUrl }) => {
...
PicklistLanguageIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistLanguageIndex);
