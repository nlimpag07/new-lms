...
import Levels from "../../../components/picklists/levels/Levels";
...
const PicklistLevelsIndex = ({ data, token, apiBaseUrl }) => {
...
PicklistLevelsIndex.getInitialProps = async (ctx) => {
...
export default withAuth(PicklistLevelsIndex);
