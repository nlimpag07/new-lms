...
targetElem.classList.replace("radial-open","redial-off");
//var targetElem = document.getElementById("courses-class") as HTMLBodyElement;
  useEffect(() => {
    return () => {
      const setCenterData = (d: any) => {
        ...
        var innerCenterGrp = svg
          ...
          .on("click", function () {
            ...
            //targetElem.classList.replace("radial-open","radial-off");
          });
  ...
  const handleAnchorClick = () => {
      //document.targetElem.classList.add("radial-open");
      targetElem.classList.add("radial-open");
      //console.log(targetElem.classList.replace("radial-off","radial-open"));
  };
