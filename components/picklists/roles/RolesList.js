...
const RolesList = ({
  ...
  const the_data = rolesData && rolesData.length ? rolesData : [];
  ...
  return (
    <>
      ...
      >
        ...
        <Column field="name" title="Role Name" />
...
function deleteConfirm(e, data, setRunSpin) {
  ...
  var config = {
    method: "delete",
    url: apiBaseUrl + "/Settings/usergroup/" + data.id,
    headers: {
      ...
      if (response) {
        ...
        if (theRes) {
          Modal.success({
            ...
            content: "You have successfully deleted a Role!",
            centered: true,
            width: 450,
            onOk: () => {
              visible: false;
