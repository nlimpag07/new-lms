...
const LanguagesEdit = ({ dataProps, hideModal, setRunSpin }) => {
  ...
  const onFinish = (values) => {
    ...
    if (!checker.length) {
      var config = {
        method: "put",
        url: apiBaseUrl + "/picklist/language/" + id,
        headers: {
